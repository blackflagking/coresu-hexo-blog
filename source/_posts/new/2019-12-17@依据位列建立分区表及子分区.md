...
(
  ...
  process_expla      VARCHAR2(300),
  process_person     VARCHAR2(300),
  trip_flight        VARCHAR2(300),
  work_frequency_no  VARCHAR2(40),
  seal_bag_time      VARCHAR2(19),
  mail_bag_label     VARCHAR2(40),
  mail_bag_no        VARCHAR2(40),
  pkg_busi_kind_code VARCHAR2(20),
  seal_bag_date      DATE,
  route_seq_num      VARCHAR2(40),
  section_code       VARCHAR2(40),
  table_td_num       VARCHAR2(40),
  dual_freq          VARCHAR2(40),
  equipmentno        VARCHAR2(40),
  seal_org_code      VARCHAR2(20),
  rcv_org_code       VARCHAR2(20),
  mway_code          VARCHAR2(100),
  route_crt_org      VARCHAR2(20),
  route_rcv_org      VARCHAR2(20),
  deal_section       VARCHAR2(60),
